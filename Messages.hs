...
messagesDict = 
    ...
    Map.insert "no up" "Cant climb up through here, go back to a ladder" $
    ...
    Map.insert "helpString" "Type 'move', 'pick up', 'use', 'inventory', or 'oxygen' for the various commands. If their use is incorrect, you will be told how to use them." $
    ...
    Map.insert "suffocated" "\n You suffocated to death, you silly goose" $
